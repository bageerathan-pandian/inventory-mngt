(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~brand-master-brand-master-module~category-master-category-master-module~company-master-compa~9ff06fac"], {
  /***/
  ...
  /***/
  function node_modulesPrimengComponentsDialogDialogJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      Dialog.prototype.toggleMaximize = function (event) {
        if (this.maximized) this.revertMaximize();else this.maximize();
        event.preventDefault();
      };
      ...
      Dialog.prototype.revertMaximize = function () {
        ...
        this.zone.runOutsideAngular(function () {
          setTimeout(function () {
            return domhandler_1.DomHandler.removeClass(_this.container, 'ui-dialog-maximized');
          }, 300);
        });
      };
      ...
      Dialog.prototype.appendContainer = function () {
        if (this.appendTo) {
          if (this.appendTo === 'body') document.body.appendChild(this.container);else domhandler_1.DomHandler.appendChild(this.container, this.appendTo);
        }
      };
      ...
      __decorate([core_1.Input(), __metadata("design:type", Boolean)], Dialog.prototype, "visible", void 0);
      ...
      __decorate([core_1.Input(), __metadata("design:type", Number)], Dialog.prototype, "minX", void 0);

      __decorate([core_1.Input(), __metadata("design:type", Number)], Dialog.prototype, "minY", void 0);

      __decorate([core_1.Input(), __metadata("design:type", Boolean)], Dialog.prototype, "focusOnShow", void 0);

      __decorate([core_1.Input(), __metadata("design:type", Boolean)], Dialog.prototype, "maximizable", void 0);

      __decorate([core_1.Input(), __metadata("design:type", Boolean)], Dialog.prototype, "focusTrap", void 0);

      __decorate([core_1.Input(), __metadata("design:type", String)], Dialog.prototype, "transitionOptions", void 0);

      __decorate([core_1.Input(), __metadata("design:type", String)], Dialog.prototype, "closeIcon", void 0);

      __decorate([core_1.Input(), __metadata("design:type", String)], Dialog.prototype, "minimizeIcon", void 0);

      __decorate([core_1.Input(), __metadata("design:type", String)], Dialog.prototype, "maximizeIcon", void 0);
      ...
      __decorate([core_1.ViewChild('titlebar', {
        static: false
      }), __metadata("design:type", core_1.ElementRef)], Dialog.prototype, "headerViewChild", void 0);

      __decorate([core_1.ViewChild('content', {
        static: false
      }), __metadata("design:type", core_1.ElementRef)], Dialog.prototype, "contentViewChild", void 0);

      __decorate([core_1.ViewChild('footer', {
        static: false
      }), __metadata("design:type", core_1.ElementRef)], Dialog.prototype, "footerViewChild", void 0);
      ...
      __decorate([core_1.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], Dialog.prototype, "width", null);

      __decorate([core_1.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], Dialog.prototype, "height", null);

      __decorate([core_1.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], Dialog.prototype, "minWidth", null);

      __decorate([core_1.Input(), __metadata("design:type", Object), __metadata("design:paramtypes", [Object])], Dialog.prototype, "minHeight", null);
      ...
      Dialog = __decorate([core_1.Component({
        ...
        animations: [animations_1.trigger('animation', [animations_1.state('void', animations_1.style({
          transform: 'scale(0.7)',
          opacity: 0
      ...
      }), __metadata("design:paramtypes", [core_1.ElementRef, core_1.Renderer2, core_1.NgZone])], Dialog);
      return Dialog;
    }();
    ...
    exports.DialogModule = DialogModule; //# sourceMappingURL=dialog.js.map
  ...
  /***/
  function node_modulesPrimengDialogJs(module, exports, __webpack_require__) {
    "use strict";
    /* Shorthand */
...
//# sourceMappingURL=default~brand-master-brand-master-module~category-master-category-master-module~company-master-compa~9ff06fac-es5.js.map