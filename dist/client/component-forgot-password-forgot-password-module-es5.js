...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["component-forgot-password-forgot-password-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentForgotPasswordForgotPasswordComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentForgotPasswordForgotPasswordRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentForgotPasswordForgotPasswordComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentForgotPasswordForgotPasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ForgotPasswordComponent = /*#__PURE__*/function () {
      function ForgotPasswordComponent(auth, _fb, messageService, router, spinner, sessionService) {
      ...
      _createClass(ForgotPasswordComponent, [{
        ...
        value: function checkValidity() {
          ...
          Object.keys(this.forgotForm.controls).forEach(function (key) {
            _this.forgotForm.controls[key].markAsDirty();
          });
        }
      }, {
        key: "forgotPassword",
        value: function forgotPassword() {
          ...
          this.spinner.show();
          this.auth.forgotPassword(this.forgotForm.value).subscribe(function (data) {
            console.log(data);
            ...
            if (data == 2) {
              _this2.messageService.add({
                severity: 'warn',
                summary: _this2.forgotForm.value.email,
                detail: ' No user found with that email address.!'
              });

              _this2.forgotForm.controls['email'].setErrors({
                'emailExist': true
              });

              _this2.forgotForm.controls['email'].markAsDirty(); // this. resetPassword()

            } else if (data == 1) {
              _this2.successRegister = true;

              _this2.forgotForm.controls['email'].setErrors({
                'emailExist': null
              });

              _this2.forgotForm.controls['email'].updateValueAndValidity();
            } else {
              _this2.messageService.add({
                severity: 'warn',
                summary: 'Warning!',
    ...
    ForgotPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/component/forgot-password/forgot-password.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./forgot-password.component.scss */
      "./src/app/component/forgot-password/forgot-password.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_shared_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthLoginService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], primeng_api__WEBPACK_IMPORTED_MODULE_4__["MessageService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerService"], src_app_shared_session_service__WEBPACK_IMPORTED_MODULE_7__["SessionService"]])], ForgotPasswordComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentForgotPasswordForgotPasswordModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var primeng_messages__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(primeng_messages__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */


    var primeng_message__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! primeng/message */
    "./node_modules/primeng/message.js");
    /* harmony import */


    var primeng_message__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(primeng_message__WEBPACK_IMPORTED_MODULE_8__);
    /* harmony import */
    ...
    ForgotPasswordModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], primeng_card__WEBPACK_IMPORTED_MODULE_6__["CardModule"], primeng_message__WEBPACK_IMPORTED_MODULE_8__["MessageModule"], primeng_messages__WEBPACK_IMPORTED_MODULE_7__["MessagesModule"], primeng_button__WEBPACK_IMPORTED_MODULE_9__["ButtonModule"], _forgot_password_routing_module__WEBPACK_IMPORTED_MODULE_3__["ForgotPasswordRoutingModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_10__["NgxSpinnerModule"], _header_header_module__WEBPACK_IMPORTED_MODULE_11__["HeaderModule"], _footer_footer_module__WEBPACK_IMPORTED_MODULE_12__["FooterModule"]]
    })], ForgotPasswordModule);
    /***/
  }
}]);
//# sourceMappingURL=component-forgot-password-forgot-password-module-es5.js.map