    ...
    .subscribe((data:any)=>{
      ...
      this.loading = false;   for(let sheetData of data){
        this.reportListSheet.push({
          ...
          'Invoice Date' : new Date(sheetData.invoice_purchase_details_id.invoice_date),
          'Sub Total' : sheetData.invoice_purchase_details_id.sub_total,
          'Discount' : sheetData.invoice_purchase_details_id.discount,
          'CGST' : sheetData.invoice_purchase_details_id.cgst,
          'SGST' : sheetData.invoice_purchase_details_id.sgst,
          'Total Price' : sheetData.invoice_purchase_details_id.grand_total,
          'Payment Type' : sheetData.invoice_purchase_details_id.payment_type  == 1 ? 'Cash' : 'Card',
