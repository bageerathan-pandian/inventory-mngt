...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-master-user-master-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentInventoryMngtMasterUserMasterUserMasterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentInventoryMngtMasterUserMasterUserMasterRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    UserMasterRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppComponentInventoryMngtMasterUserMasterUserMasterComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentInventoryMngtMasterUserMasterUserMasterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_image_upload_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var socket_io_client__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! socket.io-client */
    "./node_modules/socket.io-client/lib/index.js");
    /* harmony import */


    var socket_io_client__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_11__);
    /* harmony import */
    ...
    var UserMasterComponent = /*#__PURE__*/function () {
      function UserMasterComponent(router, companyService, _fb, confirmationService, messageService, userService, commonService, imageUploadService, sessionService) {
        var _this = this;
      ...
      _createClass(UserMasterComponent, [{
          ...
          this.userService.getUsers().subscribe(function (data) {
            ...
            try {
              for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var cdata = _step.value;

                _this3.userList.push(Object.assign({
                  activeStatus: cdata.status == 1 ? true : false
                }, cdata));
              }
            } catch (err) {
        ...
        key: "getUserByCompany",
        value: function getUserByCompany() {
          var _this4 = this;

          this.loading = true;
          this.userService.getUsersByCompany().subscribe(function (data) {
            console.log('userList', data);
        ...
        value: function checkValidity() {
          ...
          Object.keys(this.userForm.controls).forEach(function (key) {
            _this5.userForm.controls[key].markAsDirty();
          });
        }
      }, {
        key: "save",
        ...
        value: function _delete(data, index) {
          ...
          this.confirmationService.confirm({
            ...
            accept: function accept() {
              ...
              _this6.onRowDelete(data, index);
            }
          });
        }
      }, {
        key: "onRowAdd",
        value: function onRowAdd(user) {
          var _this7 = this;

          console.log('onRowAdd', user); // this.cars.push(newcar); 

          this.userService.addUser(user).subscribe(function (data) {
            console.log('add user', data);
            _this7.userList = [data].concat(_toConsumableArray(_this7.userList));

            _this7.socket.emit('addTodo', data);

            console.log('this.userList', _this7.userList);
        ...
        key: "onRowDelete",
        value: function onRowDelete(user, index) {
          var _this8 = this;

          console.log(user, index);
          this.userService.deleteUser(user._id).subscribe(function (data) {
            console.log('delete', data);

            _this8.userList.splice(index, 1);

            _this8.userList = _toConsumableArray(_this8.userList);
        ...
        key: "onRowUpdate",
        value: function onRowUpdate(user) {
          var _this9 = this;

          console.log('onRowUpdate', user);
          this.displayDialog = false; // this.userForm.controls.updateValueAndValidity();

          this.userService.updateUser(user).subscribe(function (data) {
            console.log('update', data);

            _this9.socket.emit('updateTodo', data);

            var sliceIndex = lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](_this9.userList, function (o) {
            ...
            if (sliceIndex > -1) {
              ...
              _this9.userList.splice(sliceIndex, 1, data);
            }

            _this9.userList = _toConsumableArray(_this9.userList);
        ...
        value: function profileImageUpload() {
          var _this10 = this;

          this.imageUploadService.profileImageUpload(this.imageChangedEvent).subscribe(function (data) {
            console.log(data);

            _this10.userForm.controls['user_image'].setValue(data);

            if (_this10.userForm.value._id) {
              _this10.onRowUpdate(_this10.userForm.value);
            } else {
              _this10.onRowAdd(_this10.userForm.value);
            }
          });
        }
      }, {
        ...
        value: function fileChangeEvent(file) {
          ...
          console.log('imageChangedEvent', this.imageChangedEvent); // show image preview

          var render = new FileReader();

          render.onloadend = function (e) {
            console.log('reslt', render);
            _this11.croppedImage = render.result;
          };
        ...
        value: function onCheckEmailExist() {
          ...
          var sliceIndex = lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](this.userList, function (o) {
            return o._id == _id;
          });
          console.log(sliceIndex);

          if (sliceIndex > -1) {
            if (this.userList[sliceIndex].user_email == this.userForm.value.user_email) {
              // when not change
          ...
          this.userService.onCheckEmailExist(this.userForm.value.user_email).subscribe(function (data) {
            ...
            if (data.length != 0) {
              ...
              _this12.userForm.controls['user_email'].setErrors({
                'emailExist': true
              });

              _this12.userForm.controls['user_email'].markAsDirty();
            } else {
              _this12.messageService.clear();

              _this12.emailCheckStatus = 1;

              _this12.userForm.controls['user_email'].setErrors({
                'emailExist': null
              });

              _this12.userForm.controls['user_email'].updateValueAndValidity();
            }
          }, function (error) {
    ...
    UserMasterComponent.ctorParameters = function () {
      return [{
  ...
  /***/
  function srcAppComponentInventoryMngtMasterUserMasterUserMasterModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _user_master_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var primeng_table__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(primeng_table__WEBPACK_IMPORTED_MODULE_4__);
    /* harmony import */
    ...
    var primeng_dialog__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(primeng_dialog__WEBPACK_IMPORTED_MODULE_9__);
    /* harmony import */
    ...
    var primeng_dropdown__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(primeng_dropdown__WEBPACK_IMPORTED_MODULE_10__);
    /* harmony import */
    ...
    var primeng_password__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(primeng_password__WEBPACK_IMPORTED_MODULE_11__);
    /* harmony import */
    ...
    var _user_master_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./user-master.component */
    "./src/app/component/inventory-mngt/master/user-master/user-master.component.ts");
    /* harmony import */
    ...
    var primeng_inputmask__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! primeng/inputmask */
    "./node_modules/primeng/inputmask.js");
    /* harmony import */


    var primeng_inputmask__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(primeng_inputmask__WEBPACK_IMPORTED_MODULE_19__);
    /* harmony import */
    ...
    UserMasterModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_user_master_component__WEBPACK_IMPORTED_MODULE_15__["UserMasterComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _user_master_routing_module__WEBPACK_IMPORTED_MODULE_3__["UserMasterRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_17__["HttpClientModule"], primeng_card__WEBPACK_IMPORTED_MODULE_8__["CardModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], primeng_inputtext__WEBPACK_IMPORTED_MODULE_6__["InputTextModule"], primeng_table__WEBPACK_IMPORTED_MODULE_4__["TableModule"], primeng_button__WEBPACK_IMPORTED_MODULE_5__["ButtonModule"], primeng_dialog__WEBPACK_IMPORTED_MODULE_9__["DialogModule"], primeng_dropdown__WEBPACK_IMPORTED_MODULE_10__["DropdownModule"], primeng_password__WEBPACK_IMPORTED_MODULE_11__["PasswordModule"], primeng_breadcrumb__WEBPACK_IMPORTED_MODULE_12__["BreadcrumbModule"], primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_13__["ConfirmDialogModule"], primeng_toast__WEBPACK_IMPORTED_MODULE_14__["ToastModule"], primeng_inputswitch__WEBPACK_IMPORTED_MODULE_16__["InputSwitchModule"], primeng_progressspinner__WEBPACK_IMPORTED_MODULE_18__["ProgressSpinnerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], primeng_inputmask__WEBPACK_IMPORTED_MODULE_19__["InputMaskModule"], ng2_tel_input__WEBPACK_IMPORTED_MODULE_20__["Ng2TelInputModule"]]
    })], UserMasterModule);
    /***/
  },
