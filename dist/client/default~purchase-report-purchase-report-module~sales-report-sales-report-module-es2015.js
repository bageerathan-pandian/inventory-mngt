...
LocaleService.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"], args: [LOCALE_CONFIG,] }] }
];
...
let ReportService = class ReportService {
    ...
    getSalesReportByCompany(from_date, to_date) {
        ...
        let httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_url + '/api/report/get-sales-report', body, { headers: httpHeaders });
    }
    getPurchaseReportByCompany(from_date, to_date) {
        ...
        let body = JSON.stringify(data);
        let httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.httpClient.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_url + '/api/report/get-purchase-report', body, { headers: httpHeaders });
    }
};
...
//# sourceMappingURL=default~purchase-report-purchase-report-module~sales-report-sales-report-module-es2015.js.map