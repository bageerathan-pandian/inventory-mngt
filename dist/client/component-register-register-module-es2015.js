...
let RegisterComponent = class RegisterComponent {
    constructor(messageService, _fb, auth, router, stripeCheckoutLoader, commonService) {
        this.messageService = messageService;
        this._fb = _fb;
        this.auth = auth;
        this.router = router;
