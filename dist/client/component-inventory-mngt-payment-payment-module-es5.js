...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["component-inventory-mngt-payment-payment-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentInventoryMngtPaymentPaymentComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentInventoryMngtPaymentPaymentRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentInventoryMngtPaymentPaymentComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentInventoryMngtPaymentPaymentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_invoice_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/shared/invoice.service */
    "./src/app/shared/invoice.service.ts");
    /* harmony import */


    var src_app_shared_print_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/shared/print.service */
    "./src/app/shared/print.service.ts");

    var PaymentComponent = /*#__PURE__*/function () {
      function PaymentComponent(router, _fb, confirmationService, messageService, invoiceService, commonService, sessionService, printService) {
        var _this2 = this;
      ...
      _createClass(PaymentComponent, [{
        ...
        value: function getInvoiceByCompany() {
          ...
          this.loading = true;
          this.invoiceService.getInvoiceByCompany().subscribe(function (data) {
            console.log('invoiceList', data);
            _this3.invoiceList = data;
        ...
        value: function getPurchaseInvoiceByCompany() {
          ...
          this.loading = true;
          this.invoiceService.getPurchaseInvoiceByCompany().subscribe(function (data) {
            console.log('p-invoiceList', data);
            _this4.purchaseInvoiceList = data;
        ...
        value: function checkValidity() {
          ...
          Object.keys(this.invoiceForm.controls).forEach(function (key) {
            _this5.invoiceForm.controls[key].markAsDirty();
          });
        }
      }, {
        key: "save",
        ...
        key: "onRowEdit",
        value: function onRowEdit(invoice) {
          console.log(invoice); // this.displayDialog = true;
        ...
        key: "onRowUpdate",
        value: function onRowUpdate(invoice) {
          var _this6 = this;

          console.log(invoice);
          this.displayDialog = false;
          this.invoiceService.updateInvoice(invoice).subscribe(function (data) {
            console.log('update', data);
            var sliceIndex = lodash__WEBPACK_IMPORTED_MODULE_4__["findIndex"](_this6.invoiceList, function (o) {
              return o._id == invoice._id;
            });
            console.log(sliceIndex);

            if (sliceIndex > -1) {
              // Replace item at index using native splice
              _this6.invoiceList.splice(sliceIndex, 1, data);
            }

            _this6.invoiceList = _toConsumableArray(_this6.invoiceList);
        ...
        key: "onCancelInvoice",
        value: function onCancelInvoice(data) {
          this.confirmationService.confirm({
            message: 'Are you sure that you want to delete this Invoice?',
            accept: function accept() {//Actual logic to perform a confirmation
    ...
    PaymentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/component/inventory-mngt/payment/payment.component.html")).default,
      providers: [primeng_api__WEBPACK_IMPORTED_MODULE_2__["ConfirmationService"]],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./payment.component.scss */
      "./src/app/component/inventory-mngt/payment/payment.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], primeng_api__WEBPACK_IMPORTED_MODULE_2__["ConfirmationService"], primeng_api__WEBPACK_IMPORTED_MODULE_2__["MessageService"], src_app_shared_invoice_service__WEBPACK_IMPORTED_MODULE_8__["InvoiceService"], src_app_shared_common_service__WEBPACK_IMPORTED_MODULE_7__["CommonService"], src_app_shared_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"], src_app_shared_print_service__WEBPACK_IMPORTED_MODULE_9__["PrintService"]])], PaymentComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentInventoryMngtPaymentPaymentModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_invoice_design_invoice_design_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
...
//# sourceMappingURL=component-inventory-mngt-payment-payment-module-es5.js.map