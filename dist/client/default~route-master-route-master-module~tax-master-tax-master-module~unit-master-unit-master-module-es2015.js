...
var MultiSelect = /** @class */ (function () {
    ...
    MultiSelect.prototype.findNextItem = function (item) {
        ...
        if (nextItem)
            return domhandler_1.DomHandler.hasClass(nextItem.children[0], 'ui-state-disabled') || domhandler_1.DomHandler.isHidden(nextItem.children[0]) ? this.findNextItem(nextItem) : nextItem.children[0];
        else
            return null;
    };
    MultiSelect.prototype.findPrevItem = function (item) {
        ...
        if (prevItem)
            return domhandler_1.DomHandler.hasClass(prevItem.children[0], 'ui-state-disabled') || domhandler_1.DomHandler.isHidden(prevItem.children[0]) ? this.findPrevItem(prevItem) : prevItem.children[0];
        else
            return null;
    };
...
//# sourceMappingURL=default~route-master-route-master-module~tax-master-tax-master-module~unit-master-unit-master-module-es2015.js.map