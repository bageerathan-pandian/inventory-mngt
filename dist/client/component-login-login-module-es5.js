...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["component-login-login-module"], {
  ...
  /***/
  function node_modulesAngular6SocialLoginAngular6SocialLoginUmdJs(module, exports, __webpack_require__) {
    (function (global, factory) {
      true ? factory(exports, __webpack_require__(
      /*! @angular/core */
      "./node_modules/@angular/core/fesm2015/core.js"), __webpack_require__(
      /*! @angular/common */
      "./node_modules/@angular/common/fesm2015/common.js"), __webpack_require__(
      /*! rxjs */
      "./node_modules/rxjs/_esm2015/index.js")) : undefined;
  ...
  function srcAppComponentLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(auth, _fb, messageService, router, spinner, sessionService, socialAuthService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function checkValidity() {
          ...
          Object.keys(this.loginForm.controls).forEach(function (key) {
            _this2.loginForm.controls[key].markAsDirty();
          });
        }
      }, {
        key: "socialSignIn",
        ...
        value: function onLogin() {
          ...
          this.auth.logIn(this.loginForm.value).subscribe(function (data) {
            ...
            if (data.user.status == 0) {
              _this4.display = true;
              _this4.errorMsg = 'Your account is deactivated by Company admin'; // this.messageService.add({severity:'error', summary:'Opps!', detail:'Your account is deactivated by Company admin!'});
            ...
            if (data.token) {
              // setTimeout(() => {
              _this4.display = false; // this.socket.emit('loginTodo', data.user);

              _this4.sessionService.setItem("inventryLogedIn", "1");

              _this4.sessionService.setItem('secret_token', data.token);

              _this4.sessionService.setUserCredentials(data.user);

              if (_this4.loginForm.value.rememberMe) {
                localStorage.setItem('user_email', data.user.user_email);
                localStorage.setItem('user_pwd', data.user.user_pwd);
                localStorage.setItem('rememberMe', _this4.loginForm.value.rememberMe);
              } else {
                localStorage.clear();
              }

              if (data.user.status == 2) {
                _this4.router.navigate(["/inventory-mngt/product-buy"]);
              } else {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthLoginService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], primeng_api__WEBPACK_IMPORTED_MODULE_4__["MessageService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerService"], src_app_shared_session_service__WEBPACK_IMPORTED_MODULE_7__["SessionService"], angular_6_social_login__WEBPACK_IMPORTED_MODULE_8__["AuthService"]])], LoginComponent);
    /***/
  },
  ...
  function srcAppComponentLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var primeng_messages__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(primeng_messages__WEBPACK_IMPORTED_MODULE_9__);
    /* harmony import */


    var primeng_message__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! primeng/message */
    "./node_modules/primeng/message.js");
    /* harmony import */


    var primeng_message__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(primeng_message__WEBPACK_IMPORTED_MODULE_10__);
    /* harmony import */
    ...
    var _header_header_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../header/header.module */
    "./src/app/component/header/header.module.ts");
    /* harmony import */


    var _footer_footer_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    var angular_6_social_login__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! angular-6-social-login */
    "./node_modules/angular-6-social-login/angular-6-social-login.umd.js");
    /* harmony import */


    var angular_6_social_login__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(angular_6_social_login__WEBPACK_IMPORTED_MODULE_16__); // Configs 


    function getAuthServiceConfigs() {
      var config = new angular_6_social_login__WEBPACK_IMPORTED_MODULE_16__["AuthServiceConfig"]([{
    ...
    LoginModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_3__["LoginRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], primeng_card__WEBPACK_IMPORTED_MODULE_5__["CardModule"], primeng_button__WEBPACK_IMPORTED_MODULE_6__["ButtonModule"], primeng_inputtext__WEBPACK_IMPORTED_MODULE_7__["InputTextModule"], primeng_messages__WEBPACK_IMPORTED_MODULE_9__["MessagesModule"], primeng_message__WEBPACK_IMPORTED_MODULE_10__["MessageModule"], primeng_toast__WEBPACK_IMPORTED_MODULE_11__["ToastModule"], primeng_checkbox__WEBPACK_IMPORTED_MODULE_12__["CheckboxModule"], _header_header_module__WEBPACK_IMPORTED_MODULE_13__["HeaderModule"], _footer_footer_module__WEBPACK_IMPORTED_MODULE_14__["FooterModule"], primeng_dialog__WEBPACK_IMPORTED_MODULE_15__["DialogModule"], angular_6_social_login__WEBPACK_IMPORTED_MODULE_16__["SocialLoginModule"]],
      providers: [{
